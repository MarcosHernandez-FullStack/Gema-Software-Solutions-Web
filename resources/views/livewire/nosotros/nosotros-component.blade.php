                                ...
                                <div class="inner-content">
                                    <div class="top-text">
                                        ...
                                        <div class="inner-title">
                                            <h3><span>GEMA</span> es una agencia de desarrollo web en Perú que se especializa en la creación 
                                    de sitios web innovadores y atractivos para el público. Nuestro equipo de desarrolladores
                                     y diseñadores talentosos ofrece soluciones personalizadas para diferentes necesidades
                                      comerciales. GEMA se dedica a elevar la presencia en línea y mejorar los resultados a través de servicios de desarrollo web de vanguardia.</h3>
                                        </div>
                                    </div>
                                    <!--ul>
                                        <li>
